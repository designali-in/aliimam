...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from 'ai-uis'
...
const AIConverter = () => {
  ...
  return (
    <div className='flex mt-20 flex-col items-center justify-center mx-auto max-w-5xl'>
      ...
      <div
        {...getRootProps()}
        className='hover:bg-muted flex cursor-pointer flex-col items-center gap-2 rounded-lg border border-dashed p-24 transition-colors duration-300'
      >
        <Icons.image strokeWidth={1} size={48} />
        <input {...getInputProps()} />
        <p className='text-slate-600 dark:text-slate-400 text-xs'>Drag some images here, or click to select files.</p>
      </div>
        ...
        <div className='w-full mt-10'>
          <div className='flex flex-col items-start gap-4 sm:flex-row sm:justify-between'>
            <div className='flex items-center justify-start gap-2'>
              <p className='text-slate-600 dark:text-slate-400 text-xs'>Convert all to</p>
              <Select
